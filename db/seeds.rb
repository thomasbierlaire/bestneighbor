...
Trajet.create!(user: u1, destination: "destination1", nbpass: "1", date: "20170601", heure: "20170601 18:00:00", takenby: "0")
Trajet.create!(user: u2, destination: "destination2", nbpass: "2", date: "20170602", heure: "20170603 18:00:00", takenby: "0")
Trajet.create!(user: u3, destination: "destination3", nbpass: "3", date: "20170603", heure: "20170602 18:00:00", takenby: "0")
Trajet.create!(user: u4, destination: "destination4takenbyuser3", nbpass: "1", date: "20170604", heure: "20170604 18:00:00", takenby: u3.id)
Trajet.create!(user: u5, destination: "destination5takenbyuser1", nbpass: "2", date: "20170605", heure: "20170605 18:00:00", takenby: u1.id)
Trajet.create!(user: u6, destination: "destination6takenbyuser2", nbpass: "3", date: "20170606", heure: "20170606 18:00:00", takenby: u2.id)
Trajet.create!(user: u7, destination: "destination7", nbpass: "1", date: "20170607", heure: "20170607 18:00:00", takenby: "0")
Trajet.create!(user: u8, destination: "destination8", nbpass: "2", date: "20170608", heure: "20170608 18:00:00", takenby: "0")
Trajet.create!(user: u9, destination: "destination1", nbpass: "1", date: "20170601", heure: "20170601 18:00:00", takenby: "0")
Trajet.create!(user: u10, destination: "destination2", nbpass: "2", date: "20170602", heure: "20170603 18:00:00", takenby: "0")
Trajet.create!(user: u11, destination: "destination3", nbpass: "3", date: "20170603", heure: "20170602 18:00:00", takenby: "0")
